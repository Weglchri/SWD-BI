...
INSERT INTO public.Project (Project_Id, Capital, Creation_Date, Task, Fk_Company_Name ) VALUES (nextval ('public.project_sequence'), 5000, current_timestamp, 'Turbinenschraubenherstellung',(SELECT company_name from public.Company WHERE company_name = 'Stahl Incorporation') );
