...
INSERT INTO public.Location (Address, Country, ZIP, City) VALUES ('Alte Poststraße 122/3', 'Austria', 8020, 'Graz');
...
INSERT INTO public.Freelancer (User_Id, Profession, Availability, Fk_Address, Hourly_Wage, Education) VALUES ((SELECT user_id from public.User WHERE user_id = 2) , 'FH Joanneum', 'available', (SELECT Address from public.location WHERE Address='Melbourne Road 88'), 13, 'Software Engineer Freelancer');
